MODULE global
	...
	! Entrepreneurial ability
        ...
        REAL(DP) :: p1_x=0.05_dp, p2_x=0.03_dp
	...
	!REAL(DP), DIMENSION(MaxAge,na+nz,nz,nlambda,ne) :: Cons_t, Hours_t, Aprime_t
 	...
 	! Aggregate variables
	    ...
	    REAL(DP) :: P, Ebar , wage, NBAR, QBAR, YBAR, GBAR, R, SSC_Payments, L_P, L_C, K_P, K_C, YBAR_P, YBAR_C, P_P, P_C
        REAL(DP) :: L_P_bench, L_C_bench, K_P_bench, K_C_bench, YBAR_P_bench, YBAR_C_bench, P_P_bench, P_C_bench
        REAL(DP) :: L_P_exp, L_C_exp, K_P_exp, K_C_exp, YBAR_P_exp, YBAR_C_exp, P_P_exp, P_C_exp
    ...
    ! Bequest Stats
	REAL(DP) :: Threshold_Share_bq, Bequest_Wealth, BQ_top_x(7), Bq_Inc(5,3), Mean_Bequest
    ...
    ! Entrepreneurs
    REAL(DP) :: Entrepreneur_10, Entrepreneur_50, Entrepreneur_25, Entrepreneur_90, &
    			& Entrepreneur_a10, Entrepreneur_a50, Entrepreneur_a20

    ! Transition 
    LOGICAL :: Use_Transition_Seed
    REAL(DP):: Debt_Absorption=0.0_dp
    INTEGER :: ti 
