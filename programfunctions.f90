...
SUBROUTINE FIND_DBN_EQ()
	...
	DO WHILE ( ( DBN_dist .ge. DBN_criteria ) .and. ( simutime .le. 250 ) )
...
SUBROUTINE  SIMULATION(bench_indx)
	...
	! Break for comment
		...
		DO simutime=1, MaxSimuTime
			...
			Std_Dev_Return_K_W_Age(1)  = sqrt( sum( (ret_k_w_20   -sum(ret_k_w_20   , Ind_K_20   ==1)/sum(Ind_K_20   )**2.0_dp , Ind_K_20   ==1) & 
										&	/real(sum(Ind_K_20   -1,DP)  )
			Std_Dev_Return_K_W_Age(2)  = sqrt( sum( (ret_k_w_21_25-sum(ret_k_w_21_25, Ind_K_21_25==1)/sum(Ind_K_21_25)**2.0_dp , Ind_K_21_25==1) & 
										&	/real(sum(Ind_K_21_25-1,DP)  )
			Std_Dev_Return_K_W_Age(3)  = sqrt( sum( (ret_k_w_26_30-sum(ret_k_w_26_30, Ind_K_26_30==1)/sum(Ind_K_26_30)**2.0_dp , Ind_K_26_30==1) & 
										&	/real(sum(Ind_K_26_30-1,DP)  )
			Std_Dev_Return_K_W_Age(4)  = sqrt( sum( (ret_k_w_31_35-sum(ret_k_w_31_35, Ind_K_31_35==1)/sum(Ind_K_31_35)**2.0_dp , Ind_K_31_35==1) & 
										&	/real(sum(Ind_K_31_35-1,DP)  )
			Std_Dev_Return_K_W_Age(5)  = sqrt( sum( (ret_k_w_36_40-sum(ret_k_w_36_40, Ind_K_36_40==1)/sum(Ind_K_36_40)**2.0_dp , Ind_K_36_40==1) & 
										&	/real(sum(Ind_K_36_40-1,DP)  )
			Std_Dev_Return_K_W_Age(6)  = sqrt( sum( (ret_k_w_41_45-sum(ret_k_w_41_45, Ind_K_41_45==1)/sum(Ind_K_41_45)**2.0_dp , Ind_K_41_45==1) & 
										&	/real(sum(Ind_K_41_45-1,DP)  )
			Std_Dev_Return_K_W_Age(7)  = sqrt( sum( (ret_k_w_46_50-sum(ret_k_w_46_50, Ind_K_46_50==1)/sum(Ind_K_46_50)**2.0_dp , Ind_K_46_50==1) & 
										&	/real(sum(Ind_K_46_50-1,DP)  )
			Std_Dev_Return_K_W_Age(8)  = sqrt( sum( (ret_k_w_51_55-sum(ret_k_w_51_55, Ind_K_51_55==1)/sum(Ind_K_51_55)**2.0_dp , Ind_K_51_55==1) & 
										&	/real(sum(Ind_K_56_55-1,DP)  )
			Std_Dev_Return_K_W_Age(9)  = sqrt( sum( (ret_k_w_56_60-sum(ret_k_w_56_60, Ind_K_56_60==1)/sum(Ind_K_56_60)**2.0_dp , Ind_K_56_60==1) & 
										&	/real(sum(Ind_K_51_60-1,DP)  )
			Std_Dev_Return_K_W_Age(10) = sqrt( sum( (ret_k_w_61_65-sum(ret_k_w_61_65, Ind_K_61_65==1)/sum(Ind_K_61_65)**2.0_dp , Ind_K_61_65==1) & 
										&	/real(sum(Ind_K_61_65-1,DP)  )
			Std_Dev_Return_K_W_Age(11) = sqrt( sum( (ret_k_w_66_70-sum(ret_k_w_66_70, Ind_K_66_70==1)/sum(Ind_K_66_70)**2.0_dp , Ind_K_66_70==1) & 
										&	/real(sum(Ind_K_66_70-1,DP)  )
			...
			Mean_Return_W_Age(1)  = sum(ret_w_20)   /totpop
			Mean_Return_W_Age(2)  = sum(ret_w_21_25)/totpop
			Mean_Return_W_Age(3)  = sum(ret_w_26_30)/totpop
			Mean_Return_W_Age(4)  = sum(ret_w_31_35)/totpop
			Mean_Return_W_Age(5)  = sum(ret_w_36_40)/totpop
			Mean_Return_W_Age(6)  = sum(ret_w_41_45)/totpop
			Mean_Return_W_Age(7)  = sum(ret_w_46_50)/totpop
			Mean_Return_W_Age(8)  = sum(ret_w_51_55)/totpop
			Mean_Return_W_Age(9)  = sum(ret_w_56_60)/totpop
			...
			do i_pct=1,9 
				...
				prc_Return_W_Age(1 ,i_pct) = Percentile(prctile_ret(i_pct),totpop,ret_w_20)
				prc_Return_W_Age(2 ,i_pct) = Percentile(prctile_ret(i_pct),totpop,ret_w_21_25)
				prc_Return_W_Age(3 ,i_pct) = Percentile(prctile_ret(i_pct),totpop,ret_w_26_30)
				prc_Return_W_Age(4 ,i_pct) = Percentile(prctile_ret(i_pct),totpop,ret_w_31_35)
				prc_Return_W_Age(5 ,i_pct) = Percentile(prctile_ret(i_pct),totpop,ret_w_36_40)
				prc_Return_W_Age(6 ,i_pct) = Percentile(prctile_ret(i_pct),totpop,ret_w_41_45)
				prc_Return_W_Age(7 ,i_pct) = Percentile(prctile_ret(i_pct),totpop,ret_w_46_50)
				prc_Return_W_Age(8 ,i_pct) = Percentile(prctile_ret(i_pct),totpop,ret_w_51_55)
				prc_Return_W_Age(9 ,i_pct) = Percentile(prctile_ret(i_pct),totpop,ret_w_56_60)
