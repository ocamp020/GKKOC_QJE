...
PROGRAM main
	...
	! Set Parameters
		...
		sigma_z_eps      = 0.0975_dp ! 0.0867_dp (Value without estate tax) ! 0.072_dp (value in old benchmark) ! params(4) !
		sigma_lambda_eps = 0.314_dp ! 0.309_dp (Value without estate tax) ! 0.305_dp (value in old benchmark) ! params(5)
		gamma  	=  0.4350_dp ! 0.4580_dp (Value without estate tax) ! 0.46_dp (value in old benchmark) !  params(6) ! 
		...
		! Corporate Sector
			A_C    = 0.9759_dp ! 0.9409_dp (value without estate tax)
