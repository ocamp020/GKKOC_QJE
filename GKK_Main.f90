...
Subroutine Solve_Opt_Threshold
	...
	print*,'Optimal Tax Loop'
	OPEN(UNIT=77, FILE=trim(Result_Folder)//'Stats_by_tau_w_threshold_3.txt', STATUS='replace')
	...
	CLOSE(unit=77) 
	    ...
	    DO tauindx=250,400,5
	    	OPEN (UNIT=77, FILE=trim(Result_Folder)//'Stats_by_tau_w_threshold_3.txt', STATUS='old', POSITION='append')
