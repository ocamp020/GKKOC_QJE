...
PROGRAM main
	...
	! Set Parameters
		...
		sigma_z_eps      = 0.0720_dp ! 0.0867_dp (Value without estate tax) ! 0.072_dp (value in old benchmark) ! params(4) !
		...
		! Bequeset parameters chi_bq*(bq+bq_0)^(1-sigma)
			...
			chi_u  = 01.00    ! Scaling 03.55_dp (value without estate tax)
