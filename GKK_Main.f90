	...
	! Set Parameters
		...
		! Debt/Output = 2.0
			! Main Parameters 
				...
				sigma_z_eps      = 0.0715_dp ! 0.0867_dp (Value without estate tax) ! 0.072_dp (value in old benchmark) ! params(4) !
				sigma_lambda_eps = 0.320_dp ! 0.309_dp (Value without estate tax) ! 0.305_dp (value in old benchmark) ! params(5)
			...
			! Capital Market
				do zi=1,nz
				theta(zi)    = 1.00_dp+(5.50_dp-1.00_dp)/(nz-1)*(real(zi,8)-1.0_dp)
				enddo
