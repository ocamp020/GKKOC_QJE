...
PROGRAM main
	...
	! Set Parameters
		...
		! Debt/Output = 1.5, lambda = 1.5, no bequest fee
			! Main Parameters 
				beta   	= 0.9621_dp ! 0.9404_dp (Value without estate tax)! 0.9475_dp (value in old benchmark) ! params(1) !
			...
			! Capital Market
				do zi=1,nz
				theta(zi)    = 1.00_dp+(2.73_dp-1.00_dp)/(nz-1)*(real(zi,8)-1.0_dp)
				enddo
