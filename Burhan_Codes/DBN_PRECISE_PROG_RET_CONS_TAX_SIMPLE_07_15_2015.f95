...
!	REAL(DP), PARAMETER  :: rho_lambda=0.5_DP, sigma_lambda_eps=0.34_DP 
	...
	INTEGER(I4B),  PARAMETER :: na=401, fine_na=801, MaxSimuTime=500 
...
MODULE global
	...
	REAL(DP), DIMENSION(ne)                            :: egrid, Ge	, cdf_Ge
 	REAL(DP), DIMENSION(ne,ne)                       :: pr_e, cdf_pr_e
                REAL(DP), DIMENSION(MaxAge,ne)              :: Ge_byage, cdf_Ge_byagez
...
! Everyone in MaxAge dies. Those who die, switch to z2, lambda2 and start at ne/2+1
    ...
    DO e1=1, ne
        ...
        DO lambda2=1,nlambda
        	DBN2(1,1, z2,lambda2,ne/2+1)   =  &
        		&	DBN2(1,1, z2, lambda2, ne/2+1) + DBN1(age1, a1, z1, lambda1, e1) &
                &   pr_z(z1,z2)  pr_lambda(lambda1,lambda2)
...
DO lambdai=1,nlambda   
DO ei=1,ne     
        RetY_lambda_e(lambdai,ei) = phi_lambda_e(lambdai,ei) * Ebart 
ENDDO
ENDDO
!print*,'yh=',yh
!print*, 'RetY =',RetY
