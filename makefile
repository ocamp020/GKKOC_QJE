...
GKK_Main.a: GKK_Main.f95 NRTYPE.o NRUTIL.o Toolbox.o parameters.o global.o programfunctions.o
	gfortran GKK_Main.f95 NRUTIL.o NRTYPE.o Toolbox.o parameters.o global.o programfunctions.o -o GKK_Main.a
	./GKK_Main.a

GKK_Main_Server.a: GKK_Main.f95 NRTYPE.o NRUTIL.o  Toolbox.o parameters.o global.o programfunctions.o
	gfortran GKK_Main.f95 NRUTIL.o NRTYPE.o Toolbox.o parameters.o global.o programfunctions.o -o GKK_Main_Server.a

GKK_Opt_Taxes.a: GKK_Optimal_Taxes.f95 NRTYPE.o NRUTIL.o Toolbox.o Opt_Tax_Parameters.o Opt_Tax_Functions.o  parameters.o global.o programfunctions.o 
...
CE_program.a: Consumption_Equivalent.f95 NRTYPE.o NRUTIL.o Toolbox.o parameters.o global.o programfunctions.o
	gfortran Consumption_Equivalent.f95 NRUTIL.o NRTYPE.o Toolbox.o parameters.o global.o programfunctions.o -o CE_program.a

GKK_Simul.a: GKK_Simul.f95 NRTYPE.o NRUTIL.o Toolbox.o parameters.o global.o programfunctions.o
	gfortran GKK_Simul.f95 NRUTIL.o NRTYPE.o Toolbox.o parameters.o global.o programfunctions.o -o GKK_Simul.a
	./GKK_Simul.a

Aux.a: Aux_File.f95 NRTYPE.o NRUTIL.o Toolbox.o parameters.o global.o programfunctions.o
